...
parameters:
  - name: "new_version"
    description: "The new version to set. E.g. '3.11.0'. Bump type is derived automatically."
  ...
  - name: "native_sdk_version"
    description: "New MoEngage-iOS-SDK version. Optional — if provided, adds 'Updated MoEngage-iOS-SDK to X' entry and updates sdkVerMin."
    optional: true
  - name: "pluginbase_version"
    description: "New MoEngagePluginBase version. Optional — if provided, adds 'Updated MoEngagePluginBase to X' entry and updates pluginbaseVerMin."
    optional: true
---
...
- **`currentVersion`** — value of `packages[0].version` (e.g. `3.10.0`)
